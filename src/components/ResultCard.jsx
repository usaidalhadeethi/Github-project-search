...
const ResultCard = ({ searchInput, showResult }) => {
    const [userData, setUserData] = useState(null);
    const [error, setError] = useState('');

    useEffect(() => {
        if (searchInput && showResult) {
                ...
                {error ? (
                    ...
                    <>
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', p: "10px" }} className='rounded'>
                            <Box sx={{ textAlign:'center',backgroundColor: '#12372a', p: '13px', width:{xs:'90px', md:'115px'} }} className='rounded'>
